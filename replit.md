...
- **ZIBA Support Assistant**: Branded in-app support chat component (ziba-support.tsx) integrated into Help Center with floating toggle button. Provides keyword-based self-service assistance for common topics (booking, lost items, payments, safety, account, cancellations, driver questions) with legal-aware response language reinforcing platform positioning. Includes escalation button ("Talk to Support Team") for human support ticket guidance.

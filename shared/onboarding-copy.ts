...
const ONBOARDING_COPY: Record<ToneStyle, OnboardingCopy> = {
  friendly: {
    welcomeHeadline: "Welcome to ZIBANA!",
    ...
    paymentExplanation: "Pay easily with your ZIBANA wallet. Add funds and ride without worrying about cash. Simple, fast, and secure.",
    supportReassurance: "Got questions? Our ZIBANA Support team is always ready to help. Just tap the support button anytime.",
    ctaText: "Let's Go!",
  ...
  formal: {
    ...
    paymentExplanation: "ZIBANA uses a secure wallet-based payment system. Fund your wallet to pay for rides seamlessly. All transactions are processed securely.",
  ...
  neutral: {
    ...
    paymentExplanation: "Use your ZIBANA wallet to pay for rides. Add funds easily and enjoy cashless travel.",
...
const DRIVER_ONBOARDING_COPY: Record<ToneStyle, OnboardingCopy> = {
  friendly: {
    welcomeHeadline: "Drive with ZIBANA!",
    welcomeSubtext: "Earn money on your own schedule. Join thousands of drivers making a living with ZIBANA.",

...
export const RIDER_SIGNAL_TYPES = [
  ...
  "ON_TIME_PICKUP",
  "PAYMENT_SUCCESS",
  "LOST_ITEM_FRAUD_DETECTED",
  "LOST_ITEM_RESOLVED",
  "ACCIDENT_REPORT_FILED",
  "ACCIDENT_SAFETY_COOPERATION",
] as const;
...
export const SIGNAL_WEIGHTS: Record<BehaviorSignalType, number> = {
  ...
  ON_TIME_ARRIVAL: +3,
  DIRECT_ROUTE: +2,
  LOST_ITEM_RETURNED: +8,
  LOST_ITEM_DENIED: -6,
  ACCIDENT_REPORT_HONEST: +5,
  ACCIDENT_SAFETY_CHECK_PASSED: +4,
  CANCELLATION: -8,
  PAYMENT_FAILURE: -10,
  DISPUTE_FILED: -5,
  ON_TIME_PICKUP: +3,
  PAYMENT_SUCCESS: +2,
  LOST_ITEM_FRAUD_DETECTED: -12,
  LOST_ITEM_RESOLVED: +3,
  ACCIDENT_REPORT_FILED: +2,
  ACCIDENT_SAFETY_COOPERATION: +4,
};
